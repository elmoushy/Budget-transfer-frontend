<!-- HeaderBar.vue -->
<template>
  <header :class="[styles.header, { [styles.darkTheme]: isDarkMode }]">
    <!-- logo + title -->
    <div :class="[styles.left, styles.logoContainer]">
      ...
      <div
        :class="[
          styles.animatedBrand,
          { [styles.active]: isLogoActive, [styles.focused]: isLogoFocused },
        ]"
        role="img"
    ...
    <div :class="styles.actions">
      ...
      <div :class="styles.toggleContainer">
        <span :class="styles.toggleLabel">{{ isArabic ? 'EN' : 'AR' }}</span>
      ...
      <!-- Dark Mode Toggle -->
      <div :class="styles.toggleContainer">
        <span :class="styles.toggleLabel">{{ isDarkMode ? '☀️' : '🌙' }}</span>
        <label :class="styles.switch">
      ...
      <div :class="styles.notificationContainer">
        <button
          ...
          :class="[styles.icon, styles.bell]"
          @click="toggleNotifications"
        >
          <BellIcon />
          <span v-if="hasUnreadNotifications" :class="styles.badge"></span>
          <span v-if="newNotificationToast" :class="styles.notificationToast">
            {{ isArabic ? 'لديك إشعارات جديدة' : 'You have new notifications' }}
          </span>
        </button>
      </div>
      <!-- Logout Button -->
      <button :class="[styles.icon, styles.logout]" @click="logout">
        <LogOutIcon />
      </button>
    </div>
  </header>
