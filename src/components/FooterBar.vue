<!-- FooterBar.vue -->
<template>
  <footer class="footer" :class="{ 'dark-theme': isDarkMode }">
    <!-- Bottom Bar -->
...
.footer {
  ...
  color: #1a1423;
  margin-top: auto;
  border-top: 1px solid rgba(228, 201, 214, 0.3);
  position: relative;
  overflow: hidden;
}
...
/* Footer Bottom */
.footer-bottom {
  border-top: 1px solid rgba(228, 201, 214, 0.2);
...
.footer.dark-theme .footer-bottom {
  border-top: 1px solid rgba(81, 32, 60, 0.3);
