  ...
  <div class="home-page" :class="{ 'dark-mode': isDarkMode }">
    ...
    <div class="toolbar">
      <button class="btn-primary" @click="openNewRequestModal">
        ...
        {{ isArabic ? 'طلب تسوية جديد' : 'New Request' }}
      </button>
      ...
      <transition-group name="table-fade" tag="table" class="main-table">
        <thead key="head">
          <tr>
            ...
            <th>{{ tableHeaders.adjustmentPeriod }}</th>
            <th>{{ tableHeaders.requestDate }}</th>
            <th>{{ tableHeaders.adjustmentDescription }}</th>
    ...
    <div v-if="showModal" class="modal-overlay" @click="closeModal">
      <div class="modal-container" :class="{ 'dark-mode': isDarkMode }" @click.stop>
        <div class="modal-header">
          <h2>{{ isArabic ? 'طلب تسوية جديد' : 'New Adjustment Request' }}</h2>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="timePeriod" class="required">
              {{ isArabic ? 'شهر التسوية' : 'Adjustment Period' }}
            </label>
...
const englishHeaders = {
  ...
  giPostingStatus: 'GI-posting Status',
...
const arabicHeaders = {
  ...
  giPostingStatus: 'حالة التسيئة في نظام الاوراكل',
  adjustmentPeriod: 'شهر التسوية',
  requestDate: 'تاريخ الطلب',
  adjustmentDescription: 'وصف التسوية',
  requestedBy: 'طلب من',
  amount: 'المبلغ',
  code: 'كود',
}
...
function openNewRequestModal() {
  ...
  newRequest.value = { timePeriod: '', adjustmentReason: '' }
...
function submitRequest() {
  ...
  // Update adjustment reason with editor content
  newRequest.value.adjustmentReason = editorContent.value
