import {
  require_Delta
} from "./chunk-LWZBEIMH.js";
import "./chunk-5IKSHLI2.js";
import {
  __commonJS,
  __export,
  __publicField,
...
baseForOwn_default(LazyWrapper_default.prototype, function(func, methodName) {
  var checkIteratee = /^(?:filter|find|map|reject)|While$/.test(methodName), isTaker = /^(?:head|last)$/.test(methodName), lodashFunc = wrapperLodash_default[isTaker ? "take" + (methodName == "last" ? "Right" : "") : methodName], retUnwrapped = isTaker || methodName.startsWith("find");
  if (!lodashFunc) {
    return;
  }
